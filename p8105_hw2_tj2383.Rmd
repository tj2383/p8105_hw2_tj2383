...
-excluded variables for `class`, `topic`, `question`, `sample_size`, and everything from `confidence_limit_low` to `geo_location`
...
-created a new variable showing the proportion of responses that were “Excellent” or “Very Good” called `proportion_excellent_verygood`
```{r}
