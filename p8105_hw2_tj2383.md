...
The two original datasets, 2016 Precipitation and 2017 Precipitation were cleaned and combined to make 2016/2017 Precipitation data. There are 12 observations in the 2016 dataset and 3 observations in the 2017 dataset. The key variables in this dataset include `month` and `rainfall_amount`
